...
data = {
    ...
    "Integrals": {
        "Easy": [
            ...
            {"q": "Find $\int e^{2x} dx$.", "a": "(e^2x)/2 + C", "sol": r"Using $\int e^{ax} dx = \frac{e^{ax}}{a} + C$."},
            {"q": r"Evaluate $\int \frac{1}{x} dx$.", "a": "log|x| + C", "sol": "Standard integral form."},
            {"q": "Integrate $\int \sin(2x) dx$.", "a": "-cos(2x)/2 + C", "sol": "Integral of $\sin(ax)$ is $-\frac{\cos(ax)}{a}$."}
        ],
        "Medium": [
            {"q": "Evaluate $\int tan x dx$.", "a": "log|sec x| + C", "sol": r"Write as $\int \frac{\sin x}{\cos x} dx$ and use substitution $u = \cos x$."},
            ...
            {"q": r"Integrate $\int \frac{1}{\sqrt{1-x^2}} dx$.", "a": "sin^-1 x + C", "sol": "Standard inverse trig integral."}
        ],
        "Hard": [
            {"q": r"Evaluate $\int \frac{2x}{(x^2+1)(x^2+3)} dx$.", "a": "log|(x^2+1)/(x^2+3)| + C", "sol": "Substitute $u = x^2 \implies du = 2x dx$. Then use partial fractions."},
            ...
            {"q": r"Integrate $\int \frac{dx}{\sin(x-a)\sin(x-b)}$.", "a": "1/sin(a-b) log|sin(x-a)/sin(x-b)| + C", "sol": "Multiply and divide by $\sin(a-b)$, then write numerator as $\sin((x-b)-(x-a))$."}
        ],
        "Expert": [
            ...
            {"q": r"Evaluate $\int_0^1 \frac{\log(1+x)}{1+x^2} dx$.", "a": "pi/8 log 2", "sol": "Substitute $x = \tan \theta$, then use properties of definite integrals."},
            ...
            {"q": r"Evaluate $\int \frac{x^2+1}{x^4+1} dx$.", "a": "1/sqrt(2) tan^-1((x^2-1)/(x sqrt(2))) + C", "sol": "Divide numerator and denominator by $x^2$, then substitute $u = x - 1/x$."},
            {"q": r"Find $\int \frac{dx}{(x+1)\sqrt{x^2-1}}$.", "a": "sqrt((x-1)/(x+1)) + C", "sol": "Substitute $x+1 = 1/t$."}
        ]
    },
